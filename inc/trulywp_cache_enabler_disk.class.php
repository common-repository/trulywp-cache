...
/**
* TrulyWP_Cache_Enabler_Disk
*
* @since 1.0.0
*/

final class TrulyWP_Cache_Enabler_Disk {
    ...
    */
    ...
    public static function check_expiry() {
        ...
        $options = TrulyWP_Cache_Enabler::$options;
    ...
    */
    ...
    private static function _twp_read_settings($settings_file) {
    ...
    */
    ...
    public static function record_advcache_settings($settings) {
        $settings_file = sprintf('%s-%s%s.json',
            WP_CONTENT_DIR. "/cache/trulywp-cache-advcache",
            parse_url(
                'http://' .strtolower($_SERVER['HTTP_HOST']),
                PHP_URL_HOST
            ),
        ...
        $settings = array_merge(self::_twp_read_settings($settings_file), $settings);
    ...
    */
    ...
    public static function delete_advcache_settings($remsettings = array()) {
        ...
        $settings = self::_twp_read_settings($settings_file);
